...
describe('API Tests:', () => {
    ...
    describe('GET', () => {
        describe('#aggregateFsObjectsStates', () => {
        ...
        describe('#aggregateStatesFsObjects', () => {
    ...
    describe('PATCH', () => {
        ...
        describe('#updateShortcut', () => {
            it('should update a shortcut', async () => {
                ...
                await request(app)
                    .patch(`/api/fs/shortcut/${shortcut.fsObjectId}`)
                    .send({ name: 'shortcut2' })
                    .expect(200);
